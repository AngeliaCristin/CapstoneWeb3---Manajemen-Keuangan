    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Manajemen Keuangan 2024/2025</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="?page=masuk"><i class="glyphicon glyphicon-floppy-save"></i> Dana Masuk</a>
                    </li>

                    <li>
                        <a href="?page=keluar"><i class="glyphicon glyphicon-floppy-open"></i> Dana Keluar</a>
                    </li>

                    <li>
                        <a href="?page=rekap"><i class="glyphicon glyphicon-tasks"></i> Rekapitulasi Dana</a>
                    </li>
